        ...
        <div className="max-w-md mx-auto">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join PlantG to identify and treat plant diseases</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="btn bg-primary-500 hover:bg-primary-600 text-white w-full py-2.5"
              >
                Create Account
              </button>
            </form>
